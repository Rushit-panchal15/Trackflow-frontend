        ...
        <nav className="navbar navbar-expand navbar-light bg-white">
          <div className="container-fluid">
            <a href="/" className="navbar-brand">
              <span className="text-primary font-weight-bold">Trackflow</span>
            </a>
        ...
        <div className="content-wrapper bg-white">
          ...
          <section id="users" className="content py-5 bg-light">
            <div className="container-fluid">
              <div className="text-center mb-5">
                ...
                <p className="lead text-muted">Trackflow is designed for everyone</p>
              </div>
              <div className="row">
                {[
                  { 
          ...
          <div className="content-header bg-primary text-white py-5 text-center">
            <div className="container-fluid">
              ...
              <p className="lead mb-4">Join thousands of users who have improved their financial health with Trackflow</p>
              <div>
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-md-4 mb-4">
                  <h5 className="text-primary">Trackflow</h5>
